<template>
  <div>
    <Button type="primary" @click="hanldeShowImgPreview">show ImgPreview</Button>
    <ImgPreview
      v-model:visible="showImgPreview"
      :imgsData="imgsData"
      :showIndex="0"
      :options="{ clickMaskClose: true, closeIcon: true, download: true }" 
    />
  </div>
</template>
